...
namespace vecpar::detail {
    ...
    struct parallel_map_1 {
        TARGET virtual typename R::value_type& map(typename R::value_type& out_item,
                                                   const typename T::value_type& in_item,
                                                   Arguments... obj) = 0;
        using input_t = T;
    ...
    struct parallel_mmap_1 {
        TARGET virtual typename T::value_type& map(typename T::value_type& in_out_item,
                                                   Arguments... obj) = 0;
        using input_t = T;
        using input_ti = typename T::value_type;
        using result_t = T;
    ...
    struct parallel_mmap_2 {
        TARGET virtual typename T1::value_type& map(typename T1::value_type& in_out_item,
                                                   const typename T2::value_type& in_2_item,
                                                   Arguments... obj) = 0;
        using result_t = T1;
    ...
    struct parallel_map_5 {
        TARGET virtual typename R::value_type& map(typename R::value_type& out_item,
                                                   ...
                                                   const typename T3::value_type& in_3_item,
                                                   const typename T4::value_type& in_4_item,
                                                   const typename T5::value_type& in_5_item,
                                                   Arguments... obj) = 0;
        using result_t = R;
        using intermediate_result_t = R;
    };
