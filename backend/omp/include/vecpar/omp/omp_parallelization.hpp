...
namespace vecpar::omp {
    ...
    template <class Algorithm, typename R = typename Algorithm::intermediate_result_t,
                typename T, typename... Arguments,
                typename std::enable_if<std::is_base_of<
                    vecpar::detail::parallel_mmap_1<R, Arguments...>, Algorithm>::value>::type
                    * = nullptr>
    ...
    template <class Algorithm, typename R = typename Algorithm::intermediate_result_t,
            typename T, typename... Arguments,
            typename std::enable_if<std::is_base_of<
                    vecpar::detail::parallel_map_1<R, T, Arguments...>, Algorithm>::value>::type
            * = nullptr>
    R &parallel_map(Algorithm &algorithm,
                     __attribute__((unused)) vecmem::memory_resource &mr,
                     vecpar::config config,
    ...
    typename R::value_type &parallel_reduce(Algorithm algorithm,
        ...
        internal::offload_reduce(
                data.size(), result,
                [&](typename R::value_type *r, typename R::value_type tmp) mutable { algorithm.reduce(r, tmp); }, data);
    ...
    R &parallel_map_filter(Algorithm &algorithm, vecmem::memory_resource &mr,
        ...
        return vecpar::omp::parallel_filter<Algorithm, R>(algorithm, mr,
                                            vecpar::omp::parallel_map<Algorithm, R, T, Arguments...>(algorithm, mr, config, data, args...));
    }
    ...
    template <class MemoryResource, class Algorithm,
              ...
              typename std::enable_if_t<
                    ...
                    std::is_base_of<
                            ...
                            Algorithm>::value,
                    bool> = true>
    Result &parallel_algorithm(Algorithm algorithm,
                          MemoryResource &mr,
                          vecpar::config config,
                          T &data,
                          Arguments... args) {

        return vecpar::omp::parallel_map_reduce<Algorithm, Result, R, T, Arguments...>(algorithm, mr, config, data, args...);
    }
    ...
    Result &parallel_algorithm(Algorithm algorithm,
        ...
        return vecpar::omp::parallel_map_reduce<Algorithm, Result, R, T, Arguments...>(algorithm, mr, omp::getDefaultConfig(), data, args...);
    }

    template <class MemoryResource, class Algorithm, class R = typename Algorithm::result_t, typename T, typename... Arguments,
            typename std::enable_if_t<
                    std::is_base_of<
    ...
    R &parallel_algorithm(Algorithm algorithm,
        ...
        return vecpar::omp::parallel_map_filter<Algorithm, R, T, Arguments...>(algorithm, mr, config, data, args...);
    }
    ...
    R &parallel_algorithm(Algorithm algorithm,
        ...
        return vecpar::omp::parallel_map_filter<Algorithm, R, T, Arguments...>(algorithm, mr, omp::getDefaultConfig(), data, args...);
    }
} // namespace vecpar::omp
